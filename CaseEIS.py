...
xS = pd.read_excel('.../XSourceCase.xls', header=None)
yS = pd.read_excel('.../ySourceCase.xls', header=None)
xT = pd.read_excel('.../XTargetCase.xls', header=None)
yT = pd.read_excel('.../yTargetCase.xls', header=None)
xP = pd.read_excel('.../XPoolCase.xls', header=None)
yP = pd.read_excel('.../yPoolCase.xls', header=None)
xR = pd.read_excel('.../XRandCase.xls', header=None)
yR = pd.read_excel('.../yRandCase.xls', header=None)
yTrue = pd.read_excel('.../yTrueCase.xls', header=None)
...
np.savetxt('EIS_RMSE.csv', wl_loss, delimiter=',', header=','.join([f' {i+1}' for i in range(NRep)]), comments='')
np.savetxt('EIS_MAPE.csv', wl_mape, delimiter=',', header=','.join([f' {i + 1}' for i in range(NRep)]),
               comments='')

np.savetxt('TimeEIS.csv', ExeTime, delimiter=',',
