...
GenerateResults2D8SRandom % This provides Random2D8S.mat
GenerateResults2D8SAL % This provides AL2D8S.mat

% ALso please run the python code Simulation2D8S for NN
...
% RMSENN = readtable("D:\OneDrive - USTC\Research\Chao\05_Active learning\Code\NN4AL\Data4NN\Graphene_RMSE.csv");
RMSENN = readtable("...\Random2D8S_RMSE.csv");
RMSENN = RMSENN{2:27,:}';
...
tEndNN = readtable("...\Active2D8S_Time.csv");
tEndNN = tEndNN{2:27,:};
...
RMSENN = readtable("...\Active2D8S_RMSE.csv");
RMSENN = RMSENN{2:27,:}';
eNN = mean(RMSENN(RMSENN(:,1)~=0,Ind))';
load('Random2D8S.mat')
eOffline = mean(RMSEOffline(RMSEOffline(:,1)~=0,Ind))';
...
% MAPE Random batches
MAPENN = readtable("...\Random2D8S_MAPE.csv");
MAPENN = MAPENN{2:27,:}';
...
% MAPE Active batches
MAPENN = readtable("...\Active2D8S_MAPE.csv");
MAPENN = MAPENN{2:27,:}';
eNN = MAPENN(MAPENN(:,1)~=0,:);
eNN = eNN(:,end);
load('Random2D8S.mat')
