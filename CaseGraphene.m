...
writematrix(XSource,'XSourceGraphene.xls');
writematrix(ySource,'ySourceGraphene.xls');
writematrix(XTarget,'XTargetGraphene.xls');
writematrix(yTarget,'yTargetGraphene.xls');
writematrix(XPool,'XPoolGraphene.xls');
writematrix(yPool,'yPoolGraphene.xls');
writematrix(XRand,'XRandGraphene.xls');
writematrix(yRand,'yRandGraphene.xls');
writematrix(yTrue,'yTrueGraphene.xls');
