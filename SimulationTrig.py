...
xS = pd.read_excel('.../XSource.xls', header=None)
yS = pd.read_excel('.../ySource.xls', header=None)
xT = pd.read_excel('.../XTarget.xls', header=None)
yT = pd.read_excel('.../yTarget.xls', header=None)
xP = pd.read_excel('.../XPool.xls', header=None)
yP = pd.read_excel('.../yPool.xls', header=None)
xR = pd.read_excel('.../XRand.xls', header=None)
yR = pd.read_excel('.../yRand.xls', header=None)
yTrue = pd.read_excel('.../yTrue.xls', header=None)
...
if SelectionMethod==1:
    np.savetxt('RandomTrig_RMSE.csv', wl_loss, delimiter=',', header=','.join([f' {i+1}' for i in range(NRep)]), comments='')
    np.savetxt('RandomTrig_MAPE.csv', wl_mape, delimiter=',', header=','.join([f' {i + 1}' for i in range(NRep)]),
               comments='')
    np.savetxt('RandomTrig_Time.csv', ExeTime, delimiter=',',
               header=','.join([f' {i + 1}' for i in range(NRep)]), comments='')
else:
    np.savetxt('ActiveTrig_RMSE.csv', wl_loss, delimiter=',', header=','.join([f' {i+1}' for i in range(NRep)]), comments='')
    np.savetxt('ActiveTrig_MAPE.csv', wl_mape, delimiter=',', header=','.join([f' {i + 1}' for i in range(NRep)]),
               comments='')
    np.savetxt('ActiveTrig_Time.csv', ExeTime, delimiter=',',
               header=','.join([f' {i + 1}' for i in range(NRep)]), comments='')
