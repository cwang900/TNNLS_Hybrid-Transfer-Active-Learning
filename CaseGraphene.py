...
os.chdir(r'...\Data4NN')   # 将笔记本中的工作目录更改为主目录

xS = pd.read_excel('.../XSourceGraphene.xls', header=None)
yS = pd.read_excel('.../ySourceGraphene.xls', header=None)
xT = pd.read_excel('.../XTargetGraphene.xls', header=None)
yT = pd.read_excel('.../yTargetGraphene.xls', header=None)
xP = pd.read_excel('.../XPoolGraphene.xls', header=None)
yP = pd.read_excel('.../yPoolGraphene.xls', header=None)
xR = pd.read_excel('.../XRandGraphene.xls', header=None)
yR = pd.read_excel('.../yRandGraphene.xls', header=None)
yTrue = pd.read_excel('.../yTrueGraphene.xls', header=None)
...
NTOffline = 5000 # Number of training steps with offline target data
...
for l in range(NRep):
    ...
    xx = torch.tensor(xP.values).float()[::20,l].unsqueeze(1)
    # print(xx)
...
np.savetxt('Graphene_RMSE.csv', wl_loss, delimiter=',', header=','.join([f' {i+1}' for i in range(NRep)]), comments='')
np.savetxt('Graphene_MAPE.csv', wl_mape, delimiter=',', header=','.join([f' {i + 1}' for i in range(NRep)]),
               comments='')

np.savetxt('TimeGraphene.csv', ExeTime, delimiter=',',
