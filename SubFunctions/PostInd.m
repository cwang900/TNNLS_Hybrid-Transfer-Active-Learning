function [Mu, Sigma, alphat, Ct] = PostInd(theta,y,Xf,XStar,alpha,C,XInd,NDomain,CovType,NStream)
...
if isempty(alpha)
    [KTarget, KSTInd, KTTInd, Gxx_n_n, Inv_KS, A] =...
        CovCalInd(theta,y,Xf,XInd,CovType,NDomain,NStream);
    Ainv = eye(NT)/A;
    ...
    [Gxs_nn, A] =...
        CovCalIndOnline(theta,y,Xf,XInd,CovType,NDomain,NStream);
    PInv = eye(NInd)/C;
    GA = Gxs_nn'/A;
